            ...
            <div id="primary" class="content-area">
                <main id="main" class="site-main">
                    ...
                    <div class="shop-control-bar">
                        ...
                        <h1 class="woocommerce-products-header__title page-title">Winter Collection</h1>
                    </div>
                    <div class="tab-content">
                        <div id="grid-extended" class="tab-pane active" role="tabpanel">
                            <div class="woocommerce columns-7">
                                <div class="products">
                                    @foreach($sale as $onsale)
                                        <div class="product ">
                                            ...
                                            <span class="sku dark-code">
                                                <b>Code: {{$onsale["product-code"]}}</b>
                                            </span>
                                        </span>
                                            @if($onsale['product-quantity'] <= 0)
                                                <a class="button product_type_simple add_to_cart_button" href="javascript:void(0)">Out of Stock</a>
                                            @else
